...
export interface Translations {
  [key: string]: TranslationValue | NestedTranslations | Translations;
}
...
export const translations: Translations = {
  ...
  'checkout.login_required': {
    ru: 'ВАЖНО! Пожалуйста, войдите в аккаунт!',
    en: 'IMPORTANT! Please log in to your account!',
    ge: 'Მნიშვნელოვანია! გთხოვთ, შედით ანგარიშზე!',
  },
