...
// Debug: Log the discount translation
console.log('Discount translation:', {
  ru: transformedTranslations.ru['cart.discount_5'],
  en: transformedTranslations.en['cart.discount_5'],
  ge: transformedTranslations.ge['cart.discount_5'],
});
